...
#endif
#if defined(CONFIG_QUEC_PROJECT_FEATURE_CUIOT) && defined(__QUEC_OEM_VER_OPC__)
extern void quec_cuiot_identity_service_start();
#endif
...
#if defined(CONFIG_QUEC_PROJECT_FEATURE_CUIOT) && defined(__QUEC_OEM_VER_OPC__)
	quec_cuiot_identity_service_start();
#endif

#ifdef CONFIG_QUEC_PROJECT_FEATURE_LBS
	ql_lbs_service_start();
#endif
#if defined(CONFIG_QUEC_PROJECT_FEATURE_CTSREG) && defined(__QUEC_OEM_VER_OPC__)
...
{    
	...
	{
		extern void quec_volte_init(void);
		quec_volte_init();
	}
#endif
