...
/*UART2_TX   */{  &hwp_iomux->pad_keyin_5_cfg_reg      ,       3 ,   QUEC_BOOT_V_NONE         },
/*UART2_RX   */{  &hwp_iomux->pad_keyin_4_cfg_reg      ,       3 ,   QUEC_BOOT_V_NONE         },
    },
    {  
        QL_BOOT_UART_PORT_3,
              /*                reg                           func     power_domain  */             
/*UART3_TX   */{  &hwp_iomux->pad_keyout_5_cfg_reg     ,       4 ,   QUEC_BOOT_V_NONE         },
/*UART3_RX   */{  &hwp_iomux->pad_keyout_4_cfg_reg     ,       4 ,   QUEC_BOOT_V_NONE         },
    }
};
...
ql_boot_uart_pin_cfg_t quec_boot_uart_pin_cfg_map[QL_BOOT_UART_PORT_NUM_MAX] = /* pin initialize */
{
    {  
        QL_BOOT_UART_PORT_2,
              /*                reg                           func     power_domain  */    
/*UART2_TX   */{  &hwp_iomux->pad_gpio_21_cfg_reg      ,       1 ,   QUEC_BOOT_V_NONE         },
/*UART2_RX   */{  &hwp_iomux->pad_gpio_20_cfg_reg      ,       1 ,   QUEC_BOOT_V_NONE         },
    },
    {  
        QL_BOOT_UART_PORT_3,
...
/*UART3_RX   */{  &hwp_iomux->pad_keyout_4_cfg_reg     ,       4 ,   QUEC_BOOT_V_NONE         },
#else          
/*UART3_TX   */{  &hwp_iomux->pad_sdmmc1_data_3_cfg_reg,       6 ,   QUEC_BOOT_V_NONE         },
/*UART3_RX   */{  &hwp_iomux->pad_sdmmc1_data_2_cfg_reg,       6 ,   QUEC_BOOT_V_NONE         },
#endif
    }
};
...
/*UART2_RX   */{  &hwp_iomux->pad_gpio_20_cfg_reg      ,       1 ,   QUEC_BOOT_V_NONE         },
    ...
    {  
        QL_BOOT_UART_PORT_3,
              /*                reg                           func     power_domain  */             
/*UART3_TX   */{  NULL                                 ,       0 ,   QUEC_BOOT_V_NONE         },
/*UART3_RX   */{  NULL                                 ,       0 ,   QUEC_BOOT_V_NONE         },
    }
};
...
//#if QL_EC200U_WITH_GNSS /* with GNSS */
              ...
              /*                reg                           func     power_domain  */    
/*SPI_1_CLK  */{  &hwp_iomux->pad_gpio_7_cfg_reg       ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_CS   */{  &hwp_iomux->pad_ap_jtag_tck_cfg_reg  ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_MOSI */{  &hwp_iomux->pad_ap_jtag_trst_cfg_reg ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_MISO */{  &hwp_iomux->pad_ap_jtag_tms_cfg_reg  ,       2 ,   QUEC_BOOT_V_NONE         },
#else /* without GNSS */
              /*                reg                           func     power_domain  */    
/*SPI_1_CLK  */{  &hwp_iomux->pad_gpio_9_cfg_reg       ,       1 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_CS   */{  &hwp_iomux->pad_gpio_10_cfg_reg      ,       1 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_MOSI */{  &hwp_iomux->pad_gpio_11_cfg_reg      ,       1 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_MISO */{  &hwp_iomux->pad_gpio_12_cfg_reg      ,       1 ,   QUEC_BOOT_V_NONE         },
#endif/* QL_EC200U_WITH_GNSS */
    },
    {  
        QL_BOOT_SPI_PORT_2,
              /*                reg                           func     power_domain  */             
/*SPI_2_CLK  */{  &hwp_iomux->pad_gpio_0_cfg_reg       ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_2_CS   */{  &hwp_iomux->pad_gpio_1_cfg_reg       ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_2_MOSI */{  &hwp_iomux->pad_gpio_2_cfg_reg       ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_2_MISO */{  &hwp_iomux->pad_gpio_3_cfg_reg       ,       2 ,   QUEC_BOOT_V_NONE         },
    }
};
#elif defined CONFIG_QL_PROJECT_DEF_EC600U
ql_boot_spi_pin_cfg_t quec_boot_spi_pin_cfg_map[QL_BOOT_SPI_PORT_NUM_MAX] = /* pin initialize */
...
ql_boot_spi_pin_cfg_t quec_boot_spi_pin_cfg_map[QL_BOOT_SPI_PORT_NUM_MAX] = /* pin initialize */
{
    {  
        QL_BOOT_SPI_PORT_1,
              /*                reg                           func     power_domain  */    
/*SPI_1_CLK  */{  NULL                                 ,       0 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_CS   */{  NULL                                 ,       0 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_MOSI */{  NULL                                 ,       0 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_MISO */{  NULL                                 ,       0 ,   QUEC_BOOT_V_NONE         },
    },
    {  
        QL_BOOT_SPI_PORT_2,
              /*                reg                           func     power_domain  */             
...
/*SPI_1_MISO */{  &hwp_iomux->pad_gpio_12_cfg_reg      ,       1 ,   QUEC_BOOT_V_NONE         },
    ...
    {  
        QL_BOOT_SPI_PORT_2,
              /*                reg                           func     power_domain  */             
/*SPI_2_CLK  */{  NULL                                 ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_2_CS   */{  NULL                                 ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_2_MOSI */{  NULL                                 ,       2 ,   QUEC_BOOT_V_NONE         },
/*SPI_2_MISO */{  NULL                                 ,       2 ,   QUEC_BOOT_V_NONE         },
    }
};
#endif
#endif
...
ql_boot_spi6_pin_cfg_t quec_boot_spi6_pin_cfg_map[QL_BOOT_SPI6_PORT_NUM_MAX] = /* pin initialize */
{
    {  
        QL_BOOT_SPI_PORT_1,
              /*                reg                           func     power_domain  */    
/*SPI_1_CLK  */{  &hwp_iomux->pad_gpio_0_cfg_reg       ,       1 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_CS   */{  &hwp_iomux->pad_gpio_1_cfg_reg       ,       1 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_SIO0 */{  &hwp_iomux->pad_gpio_2_cfg_reg       ,       1 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_SIO1 */{  &hwp_iomux->pad_gpio_3_cfg_reg       ,       1 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_SIO2 */{  &hwp_iomux->pad_gpio_4_cfg_reg       ,       1 ,   QUEC_BOOT_V_NONE         },
/*SPI_1_SIO3 */{  &hwp_iomux->pad_gpio_5_cfg_reg       ,       1 ,   QUEC_BOOT_V_NONE         },
    },
    {  
        QL_BOOT_SPI_PORT_2,
              /*                reg                           func     power_domain  */             
/*SPI_2_CLK  */{  &hwp_iomux->pad_spi_lcd_sio_cfg_reg   ,      2 ,   QUEC_BOOT_V_LCD_1V8      },
/*SPI_2_CS   */{  &hwp_iomux->pad_spi_lcd_sdc_cfg_reg   ,      2 ,   QUEC_BOOT_V_LCD_1V8      },
/*SPI_2_SIO0 */{  &hwp_iomux->pad_spi_lcd_clk_cfg_reg   ,      2 ,   QUEC_BOOT_V_LCD_1V8      },
/*SPI_2_SIO1 */{  &hwp_iomux->pad_spi_lcd_cs_cfg_reg    ,      2 ,   QUEC_BOOT_V_LCD_1V8      },
/*SPI_2_SIO2 */{  &hwp_iomux->pad_spi_lcd_select_cfg_reg,      2 ,   QUEC_BOOT_V_LCD_1V8      },
/*SPI_2_SIO3 */{  &hwp_iomux->pad_lcd_fmark_cfg_reg     ,      2 ,   QUEC_BOOT_V_LCD_1V8      },
    }
};
