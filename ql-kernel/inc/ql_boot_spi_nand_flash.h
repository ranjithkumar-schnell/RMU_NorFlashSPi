...
#define QL_BOOT_NAND_BLOCK_TOTAL_NUM        2048
#define QL_BOOT_NAND_BLOCK_PAGE_NUM         64
#define QL_BOOT_NAND_CACHE_BLOCK_COUNT      5
#define QL_BOOT_NAND_CACHE_PAGE_COUNT       QL_BOOT_NAND_BLOCK_PAGE_NUM*QL_BOOT_NAND_CACHE_BLOCK_COUNT
...
typedef struct
{
    ...
    unsigned int  logical_map_table[QL_BOOT_NAND_BLOCK_TOTAL_NUM];
