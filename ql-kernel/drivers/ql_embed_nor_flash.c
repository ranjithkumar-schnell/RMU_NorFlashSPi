...
#define QL_EMBED_NOR_FLASH_LOG(msg, ...)         QL_LOG(EMBED_NOR_FLASH, "ql_embed_nor_flash", msg, ##__VA_ARGS__)
...
static bool ql_chk_embed_flash_addr(uint32 addr,size_t size)
{
