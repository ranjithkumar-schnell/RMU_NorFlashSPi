...
/*SLEEP_IND  */{  3  ,        0,              0,        GPIO_8,    GPIO_INPUT,       PULL_UP,          QUEC_PIN_NONE,    &hwp_iomux->pad_gpio_8_cfg_reg           },
#else /* public */
...
/*NET_STATUS */{  5  ,        1,              0,        GPIO_13,   QUEC_PIN_NONE,    QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->pad_gpio_13_cfg_reg          },// hardware pin name is NET_MODE
