...
#define PACKET_ADDRESS(x,y)        ((((x)*(BLOCK_SIZE))+((y)*(PAGE_SIZE)))+(DATA_LOG_START_BLOCK)) // DATA_LOG_START_BLOCK + (x * 65536) + (y * 256) where x IS DAY NUMBER AND y IS PACKET NUMBER
